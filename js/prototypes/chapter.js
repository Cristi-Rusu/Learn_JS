...
const whiteRabbit = new SimpleRabbit('White');
...
// thanks to symbols, properties with the same name can be inside an interface
...
const matrix2 = new Matrix(3, 3, (x, y) => `(${x}, ${y})`);
console.log(matrix2);
